...
export const translations: Translations = {
  ...
  faqA7: {
    EN: "Following is User's Reputation System for Restaurant Reservations.<br /><br /> Each user starts with a Trust Score of 100. Cancellation more than 4 hours before reservation: no penalty. Cancellation within 4 hours: -15 Trust Score and +1 violation. No-show (customer does not arrive): -30 Trust Score and +2 violations. Successful visit: +3 Trust Score and reduces violation impact. Trust Score is capped between 0 and 100. Trust Levels: 70–100 - Normal, 40–69 - Warning, 20–39 - Restricted (maximum 2 active reservations), 0–19 - Blocked from creating new reservations. Following are Violation-based restrictions: 3 violations - Warning, 5 violations - 7 day block, 7 violations - 30 day block, 10 violations - 60 day block. Violations are counted only within the last 180 days. Users can recover reputation through successful visits, automatic amnesty periods, or approved support appeals. Restaurants and administrators can forgive penalties in verified force majeure situations (medical emergencies, transportation issues, restaurant faults, system errors, etc.), restoring Trust Score and removing related restrictions.",
