...
export const translations: Translations = {
  ...
  faqA10: {
    ...
    GE: "რეიტინგები ეფუძნება დადასტურებულ შეფასებებს სტუმრებისგან, ვინც რეალურად ისადილა რესტორანში ADGILI-ს საშუალებით. მხოლოდ დადასტურებულ სტუმრებს შეუძლიათ შეფასების დატოვება, რაც უზრუნველყოფს ავთენტურობას.",
