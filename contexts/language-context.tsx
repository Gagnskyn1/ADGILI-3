...
export const translations: Translations = {
  ...
  faqA1: {
    ...
    GE: "უბრალოდ ჩამოტვირთეთ აპლიკაცია Adgili, დაათვალიერეთ რესტორნები, აირჩიეთ სასურველი თარიღი და დრო, და დაადასტურეთ დაჯავშნა. ამას 30 წამზე ნაკლები დრო სჭირდება!",
