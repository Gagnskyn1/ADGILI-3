...
export const translations: Translations = {
  ...
  privacySection5: {
    ...
    RU: "Мы обрабатываем персональные данные только тогда, когда у нас есть для этого законные основания. Ниже приведены основные цели и соответствующие правовые основания согласно законодательству Грузии о защите персональных данных (Закон О защите персональных данных 2011 года с изменениями) и регламенту GDPR Европейского Союза:\n\n• Создание и управление аккаунтом — исполнение договора.\n• Обработка и управление бронированием столиков с генерацией входного QR-кода — исполнение договора.\n• Передача деталей бронирования соответствующему ресторану — исполнение договора; законный интерес (для подготовки заведения).\n•Отправка Push-уведомлений о бронировании — исполнение договора; законный интерес.\n•Push-уведомления с персонализированными предложениями и акциями — ваше согласие (вы можете отказаться в любое время в настройках приложения).\n• Предоставление ресторанам возможности видеть данные об активности, связанной с их заведением — законный интерес (улучшение сервиса).\n• Улучшение приложения и анализ использования — законный интерес.\n• Выполнение юридических обязательств — законная обязанность.",
  },
  ...
  privacySection6: {
    ...
    GE: "აპი იყენებს ორი სახის QR კოდს:\n\n6.1 შესვლის QR კოდი\nდაჯავშნის დასრულებისთანავე აპი აგენერირებს უნიკალურ QR კოდს, რომელიც დაკავშირებულია თქვენს ჯავშანთან. ობიექტში მისვლისას ჰოსტესი ასკანერებს ამ კოდს, რათა დაადასტუროს თქვენი ჯავშანი და მიანიჭოს მაგიდა. სკანირება ფიქსირდება თქვენი ვიზიტების ისტორიაში, აპში.\n\n6.2 ციფრული მენიუს QR კოდი\nმაგიდასთან დაჯდომის შემდეგ ხელმისაწვდომია მეორე QR კოდი, რომლის სკანირებაც ხსნის რესტორნის ციფრულ მენიუს. ამ კოდის სკანირება არ წარმოქმნის და არ გადასცემს თქვენ შესახებ დამატებით პერსონალურ მონაცემებს, გარდა იმისა, რომ ამ მაგიდაზე აქტიური დაჯავშნის მქონე მომხმარებელი მენიუს ნახავს.",
    RU: "Приложение использует два типа QR-кодов:\n\n6.1 Входной QR-код\nСразу после завершения бронирования приложение генерирует уникальный QR-код, связанный с вашим бронированием. По прибытии в заведение хостес сканирует этот код, чтобы подтвердить вашу бронь и назначить столик. Сканирование фиксируется в истории ваших визитов в приложении.\n\n6.2 QR-код цифрового меню\nПосле того как вы сядете за столик, вам станет доступен второй QR-код, сканирование которого открывает цифровое меню ресторана. Сканирование этого кода не генерирует и не передает никаких дополнительных персональных данных о вас, за исключением того факта, что пользователь с активным бронированием за этим столиком просматривает меню.",
  },
  privacySection7Title: {
    EN: "7. Who We Share Your Data With",
    GE: "7. ვისთან ვაზიარებთ თქვენს მონაცემებს",
    RU: "7. С кем мы делимся вашими данными",
  },
  privacySection7: {
    ...
    GE: "ჩვენ არ ვყიდით თქვენს პერსონალურ მონაცემებს. ვაზიარებთ მათ მხოლოდ შემდეგ შემთხვევებში:\n\n7.1 რესტორნებთან\nრესტორანში მაგიდის დაჯავშნისას, მხოლოდ ამ რესტორანს ვუზიარებთ შემდეგ ინფორმაციას: თქვენი სახელი გვარი, ელექტრონული ფოსტის მისამართი, მობილური ტელეფონის ნომერი (მხოლოდ განსაკუთრებული შემთხვევებისთვის — მაგ. ობიექტის დახურვა), დაჯავშნის დეტალები: თარიღი, დრო და სტუმრების რაოდენობა, და თქვენი ვიზიტების ისტორია და კვების/გასტრონომიული პრეფერენციების მონაცემები, რომლებიც კონკრეტულად ამ რესტორანს უკავშირდება.\n\nრესტორნები იყენებენ ამ მონაცემებს თქვენი მიღებისთვის მოსამზადებლად, მაგიდების განაწილებისთვის და თქვენი თანხმობის შემთხვევაში — პერსონალიზებული შეთავაზებების გასაგზავნად აპის საშუალებით. რესტორნებს არ აქვთ უფლება გამოიყენონ თქვენი საკონტაქტო მონაცემები აპის გარეთ დამოუკიდებელი მარკეტინგისთვის.\n\n7.2 მომსახურების პროვაიდერებთან\nვთანამშრომლობთ გულდასმით შერჩეულ მესამე მხარის ტექნიკურ პროვაიდერებთან (მაგ. ჰოსტინგი, ანალიტიკა, Push-შეტყობინებების სერვისები), რომლებიც ამუშავებენ მონაცემებს ჩვენი სახელით მკაცრი სახელშეკრულებო ვალდებულებების ფარგლებში.\n\n7.3 სამართლებრივი მოთხოვნები\nშეიძლება გავამჟღავნოთ თქვენი მონაცემები სამართალდამცველ ორგანოებთან ან სხვა ორგანოებთან, სადაც ეს მოითხოვება საქართველოს ან ევროკავშირის კანონმდებლობით, ან სადაც ეს აუცილებელია Adgili-ს, ჩვენი მომხმარებლების ან სხვათა უფლებების, უსაფრთხოების ან ქონების დასაცავად.\n\n7.4 ბიზნეს გარიგებები\nთუ Adgili გაერთიანდება, შეძენილ იქნება ან მოხდება აქტივების გაყიდვა, თქვენი პერსონალური მონაცემები შეიძლება გადაეცეს ამ გარიგების ფარგლებში. სადაც კანონი მოითხოვს, წინასწარ შეგატყობინებთ.",
    RU: "Мы не продаем ваши персональные данные. Мы делимся ими только в следующих случаях:\n\n7.1 С ресторанами\nПри бронировании столика в ресторане мы передаем только этому конкретному ресторану следующую информацию: Имя и фамилия, Адрес электронной почты, Номер мобильного телефона (только для особых случаев — например, закрытие заведения), Детали бронирования: дата, время и количество гостей, и история ваших посещений, а также данные о ваших гастрономических предпочтениях, относящиеся именно к этому ресторану.\n\nРестораны используют эти данные для подготовки к вашему визиту, распределения столиков и, с вашего согласия, для отправки персонализированных предложений через приложение. Рестораны не имеют права использовать ваши контактные данные для независимого маркетинга вне приложения.\n\n7.2 С поставщиками услуг\nМы сотрудничаем с тщательно отобранными сторонними техническими провайдерами (например, хостинг, аналитика, сервисы Push-уведомлений), которые обрабатывают данные от нашего имени в рамках строгих договорных обязательств.\n\n7.3 Юридические требования\nМы можем раскрыть ваши данные правоохранительным или иным органам, если это требуется по законодательству Грузии или Европейского Союза, либо если это необходимо для защиты прав, безопасности или собственности Adgili, наших пользователей или других лиц.\n\n7.4 Бизнес-сделки\nЕсли Adgili сольется с другой компанией, будет приобретена или произойдет продажа активов, ваши персональные данные могут быть переданы в рамках этой сделки. Там, где этого требует закон, мы уведомим вас заранее.",
  },
  ...
  privacySection12: {
    EN: "Under Georgian data protection law and, to the extent applicable, the GDPR, you have the following rights with respect to your personal data:\n\n• Right of access — to request a copy of the personal data we hold about you.\n• Right to rectification — to ask us to correct inaccurate or incomplete data.\n• Right to erasure — Request the deletion of your data, subject to legal data retention obligations (see Section 9).\n• Right to restriction of processing — to ask us to pause processing of your data in certain circumstances.\n• Right to data portability — to receive your data in a structured, machine-readable format where processing is based on consent or contract.\n• Right to object — to object to processing based on legitimate interests.\n• Right to withdraw consent — where processing is based on your consent, you may withdraw it at any time without affecting the lawfulness of prior processing.\n\nTo exercise any of these rights, please contact us at helloadgili@gmail.com. We will respond within 30 days. We may ask you to verify your identity before acting on your request.\n\nYou also have the right to lodge a complaint with the Personal Data Protection Service of Georgia (www.pdp.ge), or with the supervisory authority of an EU member state if you are based in the EU.",
    GE: "საქართველოს მონაცემთა დაცვის კანონმდებლობისა და, შესაბამის შემთხვევაში, GDPR-ის შესაბამისად, გაქვთ შემდეგი უფლებები:\n\n• წვდომის უფლება — მოითხოვოთ ჩვენ მიერ შენახული თქვენი მონაცემების ასლი.\n• გასწორების უფლება — მოითხოვოთ არასწორი ან არასრული მონაცემების გასწორება.\n• წაშლის უფლება — მოითხოვოთ თქვენი მონაცემების წაშლა, კანონიერი შენახვის ვალდებულებების გათვალისწინებით (იხ. პუნქტი 9).\n• დამუშავების შეზღუდვის უფლება — გარკვეულ გარემოებებში მოითხოვოთ მონაცემთა დამუშავების შეჩერება.\n• მონაცემთა გადანაცვლების უფლება — მიიღოთ თქვენი მონაცემები სტრუქტურირებულ, წასაკითხ ფორმატში.\n• წინააღმდეგობის უფლება — კანონიერ ინტერესზე დაფუძნებული დამუშავების წინააღმდეგ ქმედება.\n• თანხმობის მიღების უფლება — სადაც დამუშავება ეფუძნება თქვენს თანხმობას, ნებისმიერ დროს შეგიძლიათ გამოიხმოთ იგი.\n\nამ უფლებების განსახორციელებლად გთხოვთ დაგვიკავშირდეთ: helloadgili@gmail.com. პასუხს გაგცემთ 30 დღის ვადაში. შეიძლება მოვითხოვოთ თქვენი ვინაობის დადასტურება მოთხოვნის შესრულებამდე.\n\nასევე გაქვთ უფლება შეიტანოთ საჩივარი საქართველოს პერსონალურ მონაცემთა დაცვის სამსახურში (www.pdp.ge) ან ევროკავშირის წევრი სახელმწიფოს საზედამხედველო ორგანოში, თუ ხართ ევროკავშირის მოქალაქე.",
    RU: "В соответствии с законодательством Грузии о защите данных и, при необходимости, GDPR, у вас есть следующие права:\n\n• Право на доступ — запросить копию ваших данных, хранящихся у нас.\n• Право на исправление — потребовать исправления неверных или неполных данных.\n• Право на удаление — потребовать удаления ваших данных, с учетом законных обязательств по их хранению (см. пункт 9).\n• Право на ограничение обработки — при определенных обстоятельствах потребовать приостановки обработки данных.\n• Право на переносимость данных — получить ваши данные в структурированном, читаемом формате.\n• Право на возражение — право возразить против обработки данных, основанной на законных интересах.\n• Право на отзыв согласия — если обработка основана на вашем согласии, вы можете отозвать его в любое время.\n\nაДля реализации этих прав, пожалуйста, свяжитесь с нами по адресу: helloadgili@gmail.com. Мы ответим вам в течение 30 дней. Перед выполнением запроса мы можем потребовать подтверждения вашей личности.\n\nВы также имеете право подать жалобу в Службу по защите персональных данных Грузии (www.pdp.ge) или в надзорный орган государства-члена ЕС, если вы являетесь гражданином Европейского Союза.",
  },
